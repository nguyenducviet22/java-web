...
public class CusControl extends HttpServlet {
		...
		try {
			...
			if (customer != null && customer.isVerifyState()) {
				...
				request.setAttribute("error",
						"The username or password you entered is incorrect or you have not verify your account!");
				url = "/signIn.jsp";
			}
	...
	public static String getContent(Customer cus) {
		String link = "http://localhost:8080/26._BookStore/cus-control?act=verifying&customerCode="
				+ cus.getCustomerCode() + "&verifyCode=" + cus.getVerifyCode() + "";
